 ...
 function webseide_setup_theme_supported_features() {
	...
	add_theme_support( 'editor-color-palette',
		array(
	        ...
	        array(
	            'name' 	=> 'Content headline 1',
	            'slug' 	=> 'color_six',
	            'color' => (get_theme_mod( 'webseide_color_content_h1' ) ? get_theme_mod( 'webseide_color_content_h1' ) : '#000000'),
	        ),
	        array(
	            'name' 	=> 'Content headline 2',
	            'slug' 	=> 'color_seven',
	            'color' => (get_theme_mod( 'webseide_color_content_h2' ) ? get_theme_mod( 'webseide_color_content_h2' ) : '#3399CC'),
	        ),
	        array(
	            'name' 	=> 'Content headline 3',
	            'slug' 	=> 'color_eight',
	            'color' => (get_theme_mod( 'webseide_color_content_h3' ) ? get_theme_mod( 'webseide_color_content_h3' ) : '#66CCCC'),
	        ),
	        array(
	        ...
	        array(
	            ...
	            'slug' 	=> 'color_twelve',
	            'color' => (get_theme_mod( 'webseide_color_footer_background' ) ? get_theme_mod( 'webseide_color_footer_background' ) : '#313131'),
	        )
		)
    );

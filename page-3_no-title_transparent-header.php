<?php
/**
 * Template Name: Landing-Page ohne H1, transparenter Header
 *
 * @package webseide
 */
        	...
        	<div id="header-image">
              	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					<?php if ( get_theme_mod( 'webseide_logo' ) ) : ?>
						<img src="<?php echo get_theme_mod( 'webseide_logo' ) ; ?>" id="logo" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" style="height: <?php echo ( '' != get_theme_mod( 'webseide_header_height' ) ? ''.get_theme_mod( 'webseide_header_height') * get_theme_mod( 'webseide_logo_height').'px' : '48px'); ?>;">
					<?php else: ?>
